...
echo "CannyOS: Installing CannyOS to the first disc on this node"
RAW_IMAGE_NAME="cannyos.x86_64.raw"
curl http://{{ SERVER_IP }}/cannyos/$RAW_IMAGE_NAME.xz | xz -dc | sudo dd of=/dev/sda
